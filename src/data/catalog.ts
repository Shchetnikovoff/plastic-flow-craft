...
export const catalog: CatalogCategory[] = [
  {
    ...
    subcategories: [
      { id: "e1", name: "Ёмкости цилиндрические вертикальные с плоской крышей", slug: "vertikalnye-ploskaya", externalPath: "/catalog/emkosti/vertikalnye-ploskaya", image: "/images/evpp-flat-hero.png", description: "Вертикальные цилиндрические ёмкости из листового полипропилена с плоской крышей и плоским дном. Объём от 1 000 до 50 000 литров." },
