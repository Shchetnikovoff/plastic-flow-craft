...
export const catalog: CatalogCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: "k2", name: "КНС в корпусе из полипропилена", slug: "v-korpuse-polipropilen", externalPath: "/catalog/kns/v-korpuse-polipropilen", image: "/images/kns-pp-cutaway.jpg", description: "Канализационные насосные станции в полипропиленовом корпусе. Лёгкий монтаж, химическая стойкость, долговечность. Объём и конфигурация по техзаданию заказчика." },
    ],
  },
  {
    id: "reaktory",
