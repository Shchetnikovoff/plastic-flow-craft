...
export const catalog: CatalogCategory[] = [
  ...
  },
  {
    ...
    slug: "vodoochistka",
    subcategories: [
      { id: "v1", name: "Очистные сооружения для гальванических стоков", slug: "ochistnye-galvanika" },
      { id: "v2", name: "ФФУ флотационно-фильтровальная установка", slug: "ffu" },
      { id: "v3", name: "Ламельный отстойник / тонкослойный сепаратор", slug: "lamelnyj-otstojnik" },
      { id: "v4", name: "Мешочный обезвоживатель осадка", slug: "meshochnyj-obezvozhivatel" },
      { id: "v5", name: "Станция приготовления", slug: "stantsiya-prigotovleniya" },
      { id: "v6", name: "Станция приготовления флокулянта", slug: "stantsiya-flokulanta" },
      { id: "v7", name: "Жироуловители промышленные", slug: "zhirouloviteli" },
      { id: "v8", name: "КОС — комплексные очистные сооружения", slug: "kos" },
      { id: "v9", name: "Шкафы и стойки дозирования реагентов", slug: "shkafy-dozirovaniya" },
    ],
  },
  {
    id: "vodopodgotovka",
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: "e3", name: "Ёмкости подземные", slug: "podzemnye" },
      { id: "e4", name: "Ёмкости прямоугольные", slug: "pryamougolnye" },
      ...
      { id: "e9", name: "Ёмкость для кислоты", slug: "dlya-kisloty" },
      { id: "e10", name: "Переливные ёмкости для бассейнов", slug: "perelivnye-basseiny" },
    ],
  },
  {
    id: "reaktory",
