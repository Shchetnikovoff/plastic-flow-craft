...
import EmkostiVertikalnyePloskaya from "./pages/EmkostiVertikalnyePloskaya";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/catalog/emkosti/vertikalnye-ploskaya" element={<EmkostiVertikalnyePloskaya />} />
