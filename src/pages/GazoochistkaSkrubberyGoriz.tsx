      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 rounded-lg border border-border overflow-hidden bg-card max-w-md mx-auto">
            <img src="/images/skrubber-goriz-render-clean-v3.png" alt="Скруббер горизонтальный промышленный" className="w-full object-contain" />
        ...
        <section id="modeli" className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            <img src="/images/skrubber-goriz-render-clean-v3.png" alt="Скруббер горизонтальный" className="w-full sm:w-48 object-contain rounded-lg border border-border" />
            <div>
