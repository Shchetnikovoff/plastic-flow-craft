      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            Промышленные жироуловители предназначены для очистки сточных вод от неэмульгированных жиров, масел и жировых отложений перед сбросом в систему канализации. Устанавливаются на предприятиях общественного питания, пищевых производствах, мясо- и молокоперерабатывающих комбинатах.
          </p>
        ...
        <footer className="border-t border-border pt-6 pb-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-muted-foreground">
            <div>
              ...
              <p>ИНН 4706048501 / КПП 470601001</p>
              <p>ОГРН 1214700006498</p>
              <p>188508, Ленинградская обл., г. Ломоносов, Загородная ул., д. 21, лит. Б</p>
            </div>
            <div className="sm:text-right">
              <p>+7 (921) 932-81-12</p>
              <p>plastmetallpro@bk.ru</p>
            </div>
          </div>
        </footer>
      </main>
