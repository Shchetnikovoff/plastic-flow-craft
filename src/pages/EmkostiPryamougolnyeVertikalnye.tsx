        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-primary/5">
              ...
              <TableHead className="font-semibold">Глубина, мм</TableHead>
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>Вертикальные</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <section className="mb-10">
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground leading-tight mb-3">
            Прямоугольные вертикальные ёмкости в обрешётке
          </h1>
          <p className="text-sm text-muted-foreground mb-5">
            Вертикальная компоновка для минимального занимаемого пространства при высоких потолках. Объём от 500 до 25 000 литров.
          </p>
          <div className="flex justify-center mt-6">
            <div className="rounded-lg border border-border overflow-hidden bg-card transition-all max-w-md">
...
const EmkostiPryamougolnyeVertikalnye = () => (
  <CartProvider><EmkostiPryamougolnyeVertikalnyeInner /></CartProvider>
);
