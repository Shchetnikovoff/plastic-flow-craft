...
<div className="rounded-lg border border-border overflow-hidden bg-card"><img src="/images/uslugi-hero-1.png" alt="Монтаж оборудования" className="w-full object-contain" /></div>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">{services.map((a, i) => (<div key={i} className="flex items-start gap-2 rounded-lg border border-slate-200 bg-white p-3 hover:border-amber-400/40 hover:bg-amber-50/40 transition-colors"><a.icon className="h-4 w-4 text-primary shrink-0 mt-0.5" /><span className="text-sm text-foreground">{a.text}</span></div>))}</div>
        </section>
