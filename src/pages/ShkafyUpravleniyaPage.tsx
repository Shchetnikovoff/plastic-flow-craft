...
import { Check, Wrench, ShieldCheck, Clock, Truck, FlaskConical, ImageOff, Zap, Factory, Settings, Shield } from "lucide-react";
...
const applications = [
  { icon: Zap, text: "Управление гальваническими линиями" },
  { icon: Factory, text: "Автоматизация очистных сооружений" },
  { icon: Settings, text: "Управление насосными станциями" },
  { icon: Shield, text: "Системы мониторинга и диспетчеризации" },
  { icon: FlaskConical, text: "Управление дозированием реагентов" },
  { icon: Wrench, text: "Частотное регулирование электроприводов" },
];

const modifications = [
  { title: "Шкафы управления гальванической линией", items: ["Управление процессами покрытия", "Контроль тока и времени обработки", "Автоматизация перемещения подвесок", "Интеграция с системами промывки"] },
  { title: "Шкафы управления очистными", items: ["Управление насосами и мешалками", "Контроль дозирования реагентов", "Мониторинг параметров воды (pH, мутность)", "Аварийная сигнализация"] },
  { title: "Шкафы управления насосами", items: ["Частотное регулирование", "Защита от сухого хода", "Автоматическое переключение насосов", "Дистанционный мониторинг"] },
];
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        <Breadcrumb className="mb-6"><BreadcrumbList><BreadcrumbItem><BreadcrumbLink asChild><Link to="/catalog">Каталог</Link></BreadcrumbLink></BreadcrumbItem><BreadcrumbSeparator /><BreadcrumbItem><BreadcrumbPage>Шкафы управления</BreadcrumbPage></BreadcrumbItem></BreadcrumbList></Breadcrumb>

        <section className="mb-10">
          <p className="text-xs text-muted-foreground uppercase tracking-wider mb-2">ООО СЗПК «Пласт-Металл ПРО»</p>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground leading-tight mb-3">Шкафы управления</h1>
          <p className="text-sm text-muted-foreground mb-5">Автоматизация гальванических линий, очистных сооружений и насосных станций — надёжное управление технологическими процессами!</p>
          <Button onClick={scrollToForm}>Получить расчёт стоимости</Button>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
<div className="rounded-lg border border-border overflow-hidden bg-card"><img src="/images/shkafy-hero-1.png" alt="Шкафы управления" className="w-full object-contain" /></div>
            <div className="rounded-lg border border-border overflow-hidden bg-card"><img src="/images/shkafy-hero-2.png" alt="Системы автоматизации" className="w-full object-contain" /></div>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-base font-bold text-foreground mb-3 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Шкафы управления: от проектирования до пусконаладки</h2>
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">Мы проектируем и собираем шкафы управления для автоматизации промышленных процессов: гальванических линий, очистных сооружений, насосных станций и дозирующего оборудования.</p>
        ...
        <section className="mb-10">
          <h2 className="text-base font-bold text-foreground mb-4 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Виды шкафов управления</h2>
        ...
        {category && (
          <section className="mb-10">
            <h2 className="text-base font-bold text-foreground mb-4 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Каталог шкафов управления</h2>
        ...
        <section id="cta-form" className="mb-10 scroll-mt-20">
          <div className="rounded-xl bg-slate-900 text-white p-6 sm:p-8">
            <h2 className="text-base font-bold text-white mb-2 tracking-wide uppercase">Готовы заказать шкаф управления?</h2>
...
const ShkafyUpravleniyaPage = () => (<CartProvider><Inner /></CartProvider>);
