    ...
    <>
        ...
        <div className="mx-auto max-w-[960px] px-4 sm:px-6 py-10 sm:py-14">
          <Breadcrumb className="mb-6">
            <BreadcrumbList className="text-slate-400">
              ...
              <BreadcrumbItem><BreadcrumbPage className="text-slate-200">Гидрометаллургия</BreadcrumbPage></BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">
            Оборудование для <span className="text-amber-400">гидрометаллургии</span>
          </h1>
          <p className="text-sm sm:text-base text-slate-300 mb-6 max-w-2xl leading-relaxed">
            Реакторы, нутч-фильтры, установки выщелачивания и сорбции — полимерное оборудование для извлечения металлов.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-lg border border-slate-800 overflow-hidden bg-slate-800/50"><img src="/images/gidrometallurgiya-hero-1.png" alt="Оборудование для гидрометаллургии" className="w-full object-contain" /></div>
            <div className="rounded-lg border border-slate-800 overflow-hidden bg-slate-800/50"><img src="/images/gidrometallurgiya-hero-2.png" alt="Реакторы и фильтры" className="w-full object-contain" /></div>
          </div>
        </div>
      </section>
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section id="opisanie" className="mb-10">
          <h2 className="text-base font-bold text-foreground mb-3 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Гидрометаллургическое оборудование из полимеров</h2>
        ...
        {category && (
          <section id="katalog" className="mb-10">
            <h2 className="text-base font-bold text-foreground mb-4 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Каталог оборудования</h2>
        ...
        <section id="cta-form" className="mb-10 scroll-mt-20">
          <div className="rounded-xl bg-slate-900 text-white p-6 sm:p-8">
            <h2 className="text-base font-bold text-white mb-2 tracking-wide uppercase">Готовы заказать оборудование?</h2>
