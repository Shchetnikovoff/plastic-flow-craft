...
const features = [
  "Корпус из спирально витой трубы SVT — высокая прочность и коррозионная стойкость",
  ...
  "12 типоразмеров — от компактных бытовых до промышленных станций",
];
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-muted-foreground mb-5">
            КНС из стеклопластика — максимальная прочность и долговечность для подземного размещения.
          </p>
