...
const features = [
  "Корпус из полиэтилена — высокая прочность и коррозионная стойкость",
  ...
  "38 типоразмеров — от компактных бытовых до промышленных станций",
];

const specs = [
  { icon: Settings, title: "Конструкция", text: "Цилиндрический корпус из полиэтилена с усиленными рёбрами жёсткости. Днище плоское или коническое." },
  { icon: ShieldCheck, title: "Материал", text: "Полиэтилен — не подвержен коррозии, срок службы от 30 лет." },
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>КНС в корпусе SVT</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        {/* Hero */}
        <section className="mb-10">
          <p className="text-xs text-muted-foreground uppercase tracking-wider mb-2">9.1 КНС в корпусе SVT</p>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground leading-tight mb-3">
            Канализационные насосные станции в корпусе SVT
          </h1>
          <p className="text-sm text-muted-foreground mb-5">
            КНС из полиэтилена — максимальная прочность и долговечность для подземного размещения.
          </p>
          ...
          <div className="mt-6 rounded-lg border border-border overflow-hidden bg-card">
            <img src="/images/kns-svt-cutaway.jpg" alt="КНС в корпусе SVT — разрез" className="w-full object-contain" />
          </div>
        </section>
