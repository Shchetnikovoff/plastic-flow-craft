      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            ...
            <img src="/images/zhu-rectangular-ral.jpg" alt="Прямоугольный жироуловитель — вид сбоку" className="rounded-lg border border-border object-contain w-full aspect-[4/3]" />
          </div>
        </section>
