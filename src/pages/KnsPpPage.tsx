...
const features = [
  ...
  "Диаметр корпуса от 1300 до 2000 мм, производительность до 80 м³/ч",
...
const specs = [
  { icon: Settings, title: "Конструкция", text: "Цилиндрический корпус из полипропилена D1300–2000 мм с рёбрами жёсткости. Глубина заложения до 10 м. Сварные швы — экструзионная сварка." },
  { icon: ShieldCheck, title: "Материал", text: "Полипропилен PP-H / PP-B — устойчив к агрессивным стокам, срок службы от 25 лет. Мощность насосов до 7,5 кВт." },
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 rounded-lg border border-border overflow-hidden bg-card">
             <img src="/images/kns-pp-cutaway-v2.jpg" alt="КНС в корпусе из полипропилена — разрез" className="w-full object-contain" />
          </div>
        </section>
