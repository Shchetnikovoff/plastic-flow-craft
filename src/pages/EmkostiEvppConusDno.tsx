...
const EmkostiEvppConusDnoInner = () => {
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>С конусным дном</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        {/* Hero */}
        <section className="mb-10">
          <p className="text-xs text-muted-foreground uppercase tracking-wider mb-2">Раздел 6.1.4</p>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground leading-tight mb-3">
            Вертикальная цилиндрическая ёмкость с конусным дном
          </h1>
          <p className="text-sm text-muted-foreground mb-5">
            Вертикальная цилиндрическая ёмкость с конусообразным дном для полного слива жидкости и осаждения взвесей. Конусная форма дна обеспечивает сбор осадка в нижней точке и его контролируемый отвод через донный патрубок.
          </p>
        ...
        <section id="opisanie" className="mb-10">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            Вертикальная цилиндрическая ёмкость с конусным дном предназначена для процессов, требующих полного слива жидкости, сбора и отвода осадка. 
            Конусообразная форма дна обеспечивает гравитационное осаждение взвешенных частиц в нижнюю точку с последующим контролируемым удалением через донный патрубок.
          </p>
...
const EmkostiEvppConusDno = () => (
  <CartProvider><EmkostiEvppConusDnoInner /></CartProvider>
);
