...
<div className="rounded-lg border border-border overflow-hidden bg-card"><img src="/images/labmebel-hero-1.png" alt="Лабораторная мебель" className="w-full object-contain" /></div>
        ...
        <section className="mb-10">
          <h2 className="text-base font-bold text-foreground mb-3 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Лабораторная мебель: от проектирования до монтажа</h2>
        ...
        <section className="mb-10">
          <h2 className="text-base font-bold text-foreground mb-4 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Виды продукции</h2>
        ...
        {category && (
          <section className="mb-10">
            <h2 className="text-base font-bold text-foreground mb-4 tracking-wide uppercase border-l-4 border-amber-400 pl-3">Каталог лабораторной мебели</h2>
        ...
        <section id="cta-form" className="mb-10 scroll-mt-20">
          <div className="rounded-xl bg-slate-900 text-white p-6 sm:p-8">
            <h2 className="text-base font-bold text-white mb-2 tracking-wide uppercase">Готовы заказать лабораторную мебель?</h2>
