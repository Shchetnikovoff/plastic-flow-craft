...
const EmkostiGorizontalnyeStandardInner = () => {
      ...
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>Стандартная на низких ложементах</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        {/* Hero */}
        <section className="mb-10">
          <p className="text-xs text-muted-foreground uppercase tracking-wider mb-2">Раздел 6.2.1</p>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground leading-tight mb-3">
            Горизонтальная цилиндрическая ёмкость — стандартная на низких ложементах
          </h1>
          <p className="text-sm text-muted-foreground mb-5">
            Ёмкости из полипропилена (ПП) цилиндрические горизонтальные — стандартная форма на низких ложементах.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            <div className="rounded-lg border border-border overflow-hidden bg-card">
              <img src="/images/egts-standartnaya-1.jpg" alt="Горизонтальная ёмкость стандартная" className="w-full h-auto object-contain" />
            </div>
            <div className="rounded-lg border border-border overflow-hidden bg-card">
              <img src="/images/egts-standart-schema.jpg" alt="Схема горизонтальной ёмкости" className="w-full h-auto object-contain" loading="lazy" />
            </div>
          </div>
        </section>
...
const EmkostiGorizontalnyeStandard = () => (
  <CartProvider><EmkostiGorizontalnyeStandardInner /></CartProvider>
);
