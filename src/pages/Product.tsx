...
const ProductDetailContent = () => {
  ...
  const zhuModels = [
    ...
    // Прямоугольные (ЖУП)
    { name: "ЖУП-1", article: "СЗПК.ЖУП.1.ПП", throughput: "1", peakDischarge: "500", diameter: "600×400", height: "800", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "110", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
    { name: "ЖУП-2", article: "СЗПК.ЖУП.2.ПП", throughput: "2", peakDischarge: "1000", diameter: "800×500", height: "900", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "110", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
    { name: "ЖУП-3", article: "СЗПК.ЖУП.3.ПП", throughput: "3", peakDischarge: "1500", diameter: "1000×600", height: "1000", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "110", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
    { name: "ЖУП-5", article: "СЗПК.ЖУП.5.ПП", throughput: "5", peakDischarge: "2500", diameter: "1400×800", height: "1100", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "160", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
    { name: "ЖУП-8", article: "СЗПК.ЖУП.8.ПП", throughput: "8", peakDischarge: "4000", diameter: "1800×1000", height: "1200", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "200", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
    { name: "ЖУП-10", article: "СЗПК.ЖУП.10.ПП", throughput: "10", peakDischarge: "5000", diameter: "2000×1100", height: "1200", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "200", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
    { name: "ЖУП-15", article: "СЗПК.ЖУП.15.ПП", throughput: "15", peakDischarge: "7500", diameter: "2400×1200", height: "1300", wellDiameter: "-", inletHeight: "-", outletHeight: "-", pipeDiameter: "200", installType: "Прямоугольный наземный", backLink: "/catalog/vodoochistka/zhirouloviteli/pryamougolnye", backLabel: "Прямоугольные" },
  ];
  ...
  if (zhuModel) {
    ...
    return (
      <main className="mx-auto max-w-[960px] px-4 sm:px-6 py-6 sm:py-8">
        ...
        <ImageGalleryWithLightbox
          images={
            zhuModel.article.startsWith("СЗПК.ЖУГ")
              ? ["/images/zhu-horizontal-ral.jpg"]
              : zhuModel.article.startsWith("СЗПК.ЖУП")
              ? ["/images/zhu-rectangular-ral.jpg"]
              : zhuModel.article.startsWith("СЗПК.ЖУН")
              ? ["/images/zhu-vertical-ral.jpg"]
              : ["/images/zhu-underground-ral.jpg"]
          }
          selectedImage={selectedImage}
          onSelectedImageChange={setSelectedImage}
        />
